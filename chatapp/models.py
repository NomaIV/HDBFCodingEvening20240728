...
class Message(models.Model):
    ...
    deleted_by = models.ForeignKey("User.Model",related_name ='deleted_messages', on_delete=models.CASCADE)
...
class User_Profile(models.Model):
    user = models.OneToOneField("User.Model",on_delete=models.CASCADE)
